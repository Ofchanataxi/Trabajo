...
def normalize_rotation(input_pdf: str | Path) -> Path:
    ...
    print(input_pdf, flush=True)

    if input_pdf.name.endswith("_rot0.pdf"):
        return input_pdf
...
def extract_data_from_pdf(pdf_path: str, lattice: bool=True, pages: str="all", skip_normalization: bool=False) -> dict:
