...
async def process_pdf_by_type(
    release_type: int, 
    file: UploadFile,
    # --- 2. Aceptar los nuevos argumentos ---
    ...
    try:
        ...
        extractors = {
            ...
            333: lambda path: extractor_valor_dinamico.extraer_valor_dinamico(path, valor_a_buscar=valor_a_buscar, posicion_dato=posicion_dato, modo_busqueda=modo_busqueda)
        }
